...
describe(finishMainPhase, () => {
  ...
  describe.for<Inputs>([
    ...
    [North, UNITS_POND, [{ x: 1, y: 5 }], SOUTH_LILYPAD_UNITS],
    [South, INITIAL_POND, [{ x: 1, y: 2 }], NORTH_LEAF],
    [South, UNITS_POND, [{ x: 0, y: 2 }], NORTH_LEAF_WITH_UNIT],
    [South, INITIAL_POND, [{ x: 1, y: 0 }], NORTH_LILYPAD_UNITS],
    ...
    [North, ANOTHER_POND, [{ x: 1, y: 5 }], SOUTH_LILYPAD_UNIT],
    ...
    [South, ANOTHER_POND, [{ x: 1, y: 0 }], NORTH_LILYPAD_UNIT],
    [South, UNITS_POND, [{ x: 0, y: 1 }], NORTH_LEAF_WITH_UNITS],
    [South, ANOTHER_POND, [{ x: 1, y: 2 }], NORTH_LILYPAD_UNITS],
    [North, UNITS_POND, [{ x: 0, y: 2 }], SOUTH_LEAF_OTHER_UNIT],
    [North, ANOTHER_POND, [{ x: 1, y: 2 }], SOUTH_LILYPAD_OTHER_UNIT],
    [North, UNITS_POND, [{ x: 2, y: 3 }], SOUTH_LILYPAD_OTHER_UNIT],
    ...
    [South, UNITS_POND, [{ x: 1, y: 2 }], NORTH_LILYPAD_OTHER_UNIT],
